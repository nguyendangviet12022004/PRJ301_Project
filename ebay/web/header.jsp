            ...
            <div class="container">
                <div class="row">
                    <div class="col-12" style="text-align : left">
                        <a href="#" class="text-decoration-none me-3">Sign in or Register</a>
                    ...
                    <div class="col-md-10">
                        <form class="d-flex">
                            <input class="form-control me-2" type="search" placeholder="Search for anything..." aria-label="Search"
                                   style="border: 100% black">
                            <button class="btn" style="background-color: #007bff; color: white;" type="submit">Search</button>
                        </form>
                    </div>
            </div>
